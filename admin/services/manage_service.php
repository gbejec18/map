...
<div class="container-fluid">
    <form action="" id="service-form">
        ...
        <div class="form-group">
            <label for="name" class="control-label">Office Head Name</label>
            <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="Enter Office Head Name" value ="<?php echo isset($name) ? $name : '' ?>" required>
        </div>
        <div class="form-group">
            <label for="category_ids" class="control-label">For <small><em>(Office)</em></small></label>
    ...
    $(function(){
        $('#uni_modal').on('shown.bs.modal',function(){
            $('#category_ids').select2({
                placeholder:"Please Select the Office here.",
                width:'100%',
