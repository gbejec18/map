...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title">List of Office Heads</h3>
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  Add Office Head</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
        $('#create_new').click(function(){
			uni_modal("Add New Office Head","services/manage_service.php",'mid-large')
		})
        $('.edit_data').click(function(){
			uni_modal("Update Office Head Details","services/manage_service.php?id="+$(this).attr('data-id'),'mid-large')
		})
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this Service permanently?","delete_service",[$(this).attr('data-id')])
		})
		$('.view_data').click(function(){
			uni_modal("Office Details","services/view_service.php?id="+$(this).attr('data-id'),'mid-large')
		})
