	...
	<div class="card card-outline card-dark rounded-0 shadow">
		...
		<div class="card-body">
			...
			<fieldset>
				...
				<div class="form-group">
					<label for="max_appointment" class="control-label">Maximum Requests a day</label>
				...
				<div class="form-group">
					<label for="schedule" class="control-label">Dalaguete Appointment Schedule<small><em>i.e.(8:00 AM - 5:00 PM)</em></small></label>
					<input type="text" class="form-control form-control-sm col-sm-3" name="schedule" id="schedule" value="<?php echo $_settings->info('appointment_schedule') ?>">
				</div>
			</fieldset>
			</form>
		</div>
